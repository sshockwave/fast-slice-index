...
impl<'l> And<'l> for Axiomize {
    type And<P: 'l, Q: 'l> = <ProofRing<Self> as And<'l>>::And<P, Q>;
    fn and_intro<P, Q>()
    -> super::prop::Cert<'l, Self, Self::Imply<P, Self::Imply<Q, Self::And<P, Q>>>> {
        <ProofRing<Self> as And<'l>>::and_intro().cast()
    }
    fn and_left<P, Q>() -> super::prop::Cert<'l, Self, Self::Imply<Self::And<P, Q>, P>> {
        <ProofRing<Self> as And<'l>>::and_left().cast()
    }
    fn and_right<P, Q>() -> super::prop::Cert<'l, Self, Self::Imply<Self::And<P, Q>, Q>> {
        <ProofRing<Self> as And<'l>>::and_right().cast()
    }
}

impl<'l> Or<'l> for Axiomize {
    type Or<P: 'l, Q: 'l> = <ProofRing<Self> as Or<'l>>::Or<P, Q>;
    ...
    fn or_left<P, Q>() -> super::prop::Cert<'l, Self, Self::Imply<P, Self::Or<P, Q>>> {
        <ProofRing<Self> as Or<'l>>::or_left().cast()
    }
    fn or_right<P, Q>() -> super::prop::Cert<'l, Self, Self::Imply<Q, Self::Or<P, Q>>> {
